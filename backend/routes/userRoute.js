...
app.post('/template', async (req, res) => {
    try {
       console.log(req.body) 
        const no = await User.findByIdAndUpdate({ _id: req.body._id }, req.body);
        console.log(no)
...
app.post('/template2', async (req, res) => {
    try {
       console.log(req.body) 
        const no = await User.findByIdAndUpdate({ _id: req.body._id }, req.body);
        const user = await User.findOne({ _id: req.body._id });
...
app.post('/template3', async (req, res) => {
    try {
       console.log(req.body) 
        const no = await User.findOneAndUpdate({ _id: req.body._id }, req.body);
        const user = await User.findOne({ _id: req.body._id });
...
app.post('/template4', async (req, res) => {
    try {
       console.log(req.body) 
        const no = await User.findOneAndUpdate({ _id: req.body._id }, req.body);
        const user = await User.findOne({ _id: req.body._id });
...
app.post('/template5', async (req, res) => {
    try {
       console.log(req.body) 
        const no = await User.findOneAndUpdate({ _id: req.body._id }, req.body);
        const user = await User.findOne({ _id: req.body._id });
