        ...
        <div class="resume_left66">
          ...
          <div class="resume_content66">
            <div class="resume_item66 resume_info6666">
              ...
              <ul>
                <li>
                  <div class="data66" style={{ display: "flex-warp" }}></div>
                </li>
              </ul>
            </div>
                ...
                {user.skills.slice(0, 3).map((skill) => {
                  return (
                    <li className="skill_list66">
                      <div class="skill_name66">{skill.Technology}</div>
                ...
                {user.Certification.slice(0.3).map((cer) => {
                  return (
                    <li className="cer_list66">
                      <div>
                        {cer.YearRange}-{cer.TitleofCertification}
                        <p>{cer.Description}</p>
                      </div>
                    </li>
                  );
            ...
            <div class="resume_item66 resume_social66">
              ...
              <ul>
                ...
                <li>
                  <div class="data66">{user.Mobilenumber}</div>
                </li>
                <li>
                  <div class="data66">{user.Email}</div>
                </li>
                <li>
                  <div class="data66">{user.LinkedIn}</div>
                </li>
              </ul>
            </div>
          </div>
