    ...
    <div className="resume__8">
      <div className="resume_left">
        ...
        <div className="resume_content">
              ...
              {user.skills.map((skill) => {
                return (
                  <li style={{ breakInside: "avoid" }}>
                    <div className="skill_name">{skill.Technology}</div>
          ...
          <div
            className="resume_item resume_social"
              ...
              {user.Certification.map((cer) => {
                return (
                  <div style={{ breakInside: "avoid" }}>
                    ...
                    <p className="para__2">{cer.Description}</p>
                  </div>
                );
              })}
            </ul>
          ...
          <div
            className="resume_item resume_hobby1"
                ...
                <li style={{ breakInside: "avoid" }}>
                  ...
                  <div className="info">
                    <p className="semi-bold">
                      {exp.Company} :{" "}
                      <span className="bold__1">{exp.jobRole} </span>
                    </p>
                    <p> {exp.Rolework}</p>
                  </div>
                </li>
        ...
        <div className="resume_item resume_projects">
          ...
          <ul>
            {user.Projects.slice(0, 3).map((pro) => {
              return (
                <li>
                  <div className="date">{pro.YearRange}</div>
                  <div className="info">
                    <p className="semi-bold">{pro.Title}</p>
                    <p>{pro.Description}</p>
                  </div>
                </li>
              );
