      ...
      <div className="profile">
        <div className="profile_container1">
          ...
          <div>
            ...
            <p className="description profile_description">{user.Objective}</p>
          </div>
        </div>
      </div>
      <div className="group-1">
        <div className="skills">
          ...
          <ul className="skills_list description">
            {user.skills.map((skill) => {
              return (
                <div className="display44" style={{ breakInside: "avoid" }}>
        ...
        <div className="edu">
          ...
          {user.education.map((edu) => {
            return (
              <div
                className="edu_item display44"
                style={{ breakInside: "avoid" }}
              >
                <h4 className="item_title">
                  {edu.Qualification}{" "}
                  <p className="item_preTitle">{edu.YearRange}</p>
                </h4>
                <p className="item_subtitle">{edu.Institution}</p>
              </div>
            );
          })}
        </div>
          ...
          <div className="interest_items">
            <div className="interest_item">
              {user.Interest.map((Interest) => {
                return (
                  <span className="display44" style={{ color: "white" }}>
                    {Interest.Interest}
                  </span>
                );
              })}
        ...
        <div className="social">
          ...
          <div className="social_items">
            <p className="description">{user.LinkedIn}</p>
            <p className="description">{user.Mobilenumber}</p>
      ...
      <div className="group-2">
        ...
        <div className="awards">
          ...
          {user.Projects.map((pro) => {
            return (
              <div
                className="awards_item display44"
                style={{ breakInside: "avoid" }}
              >
