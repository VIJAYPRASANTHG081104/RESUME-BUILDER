          ...
          <div class="right55">
            <div class="header55">
              <div class="name_role55">
                ...
                <div class="role55">{user.Role}</div>
              </div>
              <div class="about55">{user.Objective}</div>
            </div>
            <div class="right_inner55">
              <div class="exp55">
                <div class="title55">experience</div>
                  ...
                  <ul>
                    {user.Experience.slice(0, 3).map((exp) => {
                      return (
                        <li>
                          <div class="li_wrap55">
                            <div class="date55">{exp.YearRange}</div>
                            <div class="info55">
                              <p class="info_title55">{exp.jobRole}</p>
                              <p class="info_com55">{exp.Company}</p>
                              <p class="info_cont55">{exp.Rolework}</p>
                            </div>
                          </div>
                        </li>
                      );
              ...
              <div class="education55">
                <div class="title55">Education</div>
                  ...
                  <ul>
                    {user.education.slice(0, 3).map((edu) => {
                      return (
                        <li>
                          <div class="li_wrap55">
                            <div class="date55">{edu.YearRange}</div>
                            <div class="info55">
                              <p class="info_title55">{edu.Qualification}</p>
                              <p class="info_com55">{edu.Institution}</p>
                              <p class="info_cont55">{edu.EduDes} </p>
                            </div>
                          </div>
                        </li>
                      );
