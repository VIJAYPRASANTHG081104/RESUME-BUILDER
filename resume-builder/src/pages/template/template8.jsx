    ...
    <div className="template7">
      <div id="page-wrap77">
        ...
        <div id="contact-info77" class="vcard77">
          ...
          <p>
            Cell: <span class="tel77">{user.Mobilenumber}</span>
            <br />
            Email: {user.Email}
            <br />
              ...
              return (
                <div className="print77">
                  <h2>
                    {exp.Company}
                    <span>
                      {exp.jobRole} - {exp.Place} - {exp.YearRange}
                    </span>
                  </h2>
                  <ul>
                    <li>{exp.Rolework}</li>
          ...
          <dd>
            {user.Certification.slice(0, 3).map((cer) => {
              return (
                <div className="print77">
                  <h2>
                    {cer.TitleofCertification}
                    <span>{cer.YearRange}</span>
                  </h2>
                  <ul>
